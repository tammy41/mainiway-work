...
$(function(){
    ...
    $('.navlist').append(
        ...
        '<li><a href="designer.html" class="language_iDinDesign sj">设计</a></li>'+
        '<li><a href="../interactive/interactive.html" class="language_iDinSave">社区</a></li>'
    );
        ...
        '<div class="childnavlist">'+
            '<div class="w1200">'+
                ...
                '<ul class="downList downList_3">'+
                    '<li><a href="designWorks.html" class="language_works">作品</a></li>'+
                    '<li><a href="designer.html" class="language_designers">设计师</a></li>'+
                    '<li><a href="machineDesign.html" class="language_onlineDesign">在线设计</a></li>'+
                '</ul>'+
